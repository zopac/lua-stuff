loadstring(game:HttpGet("https://raw.githubusercontent.com/zopac/lua-stuff/main/script%20hub%202.lua", true))()

--SCRIPTS

-- Admin: do i need to tell u what the fuck an admin script is
...
-- Notoriety: once again its the fucking name its just a script for notoriety
